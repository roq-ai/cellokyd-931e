...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'team-member', 'guest-user', 'dealers', 'vendors'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Dealer', path: '/dealers', entity: 'dealer', service: AccessServiceEnum.PROJECT, icon: FiTruck },
    {
      name: 'Guest User',
      path: '/guest-users',
      entity: 'guest_user',
    ...
    { name: 'Vendor', path: '/vendors', entity: 'vendor', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
